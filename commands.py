# SnekBot Commands List
# 
# This program contains the commands and phrase list for the python discord bot.
#
...
uwuWords = ["uwu", "owo", "UwU", "OwO"]

sadWords = ["sad", "unhappy", "depressed", "angry", "miserable", "mad"]

happyWords = ["joy", "happy", "excited", "positive", "glad"]

motivateMsg = ["Cheer up!", "Hang in there!", "You are doing great!"]

defaultMsg = ["That's cool, bro.", "Nice", "That's great honey!", "Aye aye, detective!", "Oh captain, my captain!"]
